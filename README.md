...
If using simple Markov chain model, run cmm.py
> python cmm.py

If using Hidden Markov Model, run HMM_3rd_draft.py
> python HMM_3rd_draft.py
...
```
pieces = ["mid/hilarity.mid", "mid/froglegs.mid"]
```
